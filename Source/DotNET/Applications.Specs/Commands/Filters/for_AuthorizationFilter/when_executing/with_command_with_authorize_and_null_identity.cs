...
public class with_command_with_authorize_and_null_identity : given.an_authorization_filter
{
    ...
    void Establish()
    {
        ...
        _user.Identity.Returns((System.Security.Principal.IIdentity?)null);
    }
