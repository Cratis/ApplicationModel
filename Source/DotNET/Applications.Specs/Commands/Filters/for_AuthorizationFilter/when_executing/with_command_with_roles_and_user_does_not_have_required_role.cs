...
public class with_command_with_roles_and_user_does_not_have_required_role : given.an_authorization_filter
{
    CommandResult _result;

    void Establish()
    {
        SetupCommandWithType(typeof(given.CommandWithRoles), new given.CommandWithRoles());
