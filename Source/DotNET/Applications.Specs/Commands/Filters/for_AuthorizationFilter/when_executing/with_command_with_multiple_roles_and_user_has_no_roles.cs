...
public class with_command_with_multiple_roles_and_user_has_no_roles : given.an_authorization_filter
{
    CommandResult _result;

    void Establish()
    {
        SetupCommandWithType(typeof(given.CommandWithMultipleRoles), new given.CommandWithMultipleRoles());
