...
public class with_command_with_cratis_roles_and_user_has_required_role : given.an_authorization_filter
{
    CommandResult _result;

    void Establish()
    {
        SetupCommandWithType(typeof(given.CommandWithCratisRoles), new given.CommandWithCratisRoles());
