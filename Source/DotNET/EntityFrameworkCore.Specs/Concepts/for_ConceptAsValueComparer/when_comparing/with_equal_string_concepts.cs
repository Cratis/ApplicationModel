...
public class with_equal_string_concepts : given.a_concept_as_value_comparer
{
    ...
    void Establish()
    {
        _left = new TestStringConcept("same value");
        _right = new TestStringConcept("same value");
    }
