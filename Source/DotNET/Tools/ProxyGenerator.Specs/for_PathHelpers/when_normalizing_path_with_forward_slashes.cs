...
namespace Cratis.Arc.ProxyGenerator.for_PathHelpers;

public class when_normalizing_path_with_forward_slashes : Specification
{
    string _result;
    string _input;

    void Establish() => _input = "some/path/to/file";
