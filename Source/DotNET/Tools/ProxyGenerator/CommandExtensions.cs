...
public static class CommandExtensions
{
    ...
    public static CommandDescriptor ToCommandDescriptor(this MethodInfo method, IEnumerable<PropertyDescriptor> properties, IEnumerable<RequestArgumentDescriptor> arguments, string route, string targetPath, int segmentsToSkip)
    {
